...
Item {
    ...
    readonly property bool shouldBeActive: (visibilities.sidebar && Config.sidebar.enabled) || (visibilities.utilities && Config.utilities.enabled && !(visibilities.session && Config.session.enabled))
